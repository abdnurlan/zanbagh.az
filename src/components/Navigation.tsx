...
const navLinks = [
  ...
  { label: "Proses", href: "#experience" },
  { label: "Məhsullar", href: "#products" },
  { label: "Hakkımızda", href: "#about" },
  { label: "Məkan", href: "#location" },
];
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-10">
            {navLinks.map((link, i) => (
              ...
              >
                {link.label}
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-[var(--rose-light)] group-hover:w-full transition-all duration-300 ease-out" />
              </motion.button>
            ))}
          </nav>
          ...
          <div className="hidden md:flex items-center gap-4">
            <motion.a
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-semibold tracking-[0.15em] uppercase transition-all duration-300"
              style={{
                background: "linear-gradient(135deg, var(--rose-dark) 0%, var(--gold) 100%)",
                color: "var(--ivory)",
              }}
              whileHover={{ scale: 1.04, boxShadow: "0 8px 30px rgba(232,164,176,0.4)" }}
              whileTap={{ scale: 0.97 }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            <nav className="flex flex-col items-center gap-8 relative z-10">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 px-8 py-3 rounded-full text-sm font-semibold tracking-[0.2em] uppercase"
                style={{
                  background: "linear-gradient(135deg, var(--rose-dark) 0%, var(--gold) 100%)",
                  color: "var(--ivory)",
                }}
